<template>
	<div id="form" class="profile__form user-form col">
		<div class="row">
			<div class="col-12 profile__form--section">
				...
				<div class="second-group two__inputs--flex">
					<div class="group">      
							<input id="inputField" type="text" 
				      		ref="phoneInput"
				      		v-mask="'(###) ###-####'"
			...
			<div class="col-12 profile__form--section">
				<div class="third-group two__inputs--flex">
					<div class="group">      
				      <input id="inputField" 
				      		type="text"
				      		ref="edInput"
				...
				<div class="fourth-group two__inputs--flex">
					<div class="group">      
				      <input id="inputField" type="text" 
				      		ref="inInput"
				      		v-model.trim="editIn" 
				...
				<div class="fifth-group two__inputs--flex">
					<div class="group">      
				      <input id="inputField" type="text" 
				      		ref="haInput" 
